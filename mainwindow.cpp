...
void MainWindow::on_actionExportar_para_Excel_triggered()
{
    try
    {
             ...
             //TABELA DE PRODUTOS
             QSqlQuery lista = persistenciaProdutos.criarListaCadastrados("order by id");
             ...
             //TABELA DE CLIENTES
             lista = persistenciaClientes.criarListaCadastrados("order by id");
             ...
             //TABELA DE VENDAS
             lista = persistenciaVendas.criarListaCadastrados("order by id");
...
void MainWindow::on_actionDeletar_Dados_triggered()
{
    ...
    {     
        ...
        confirmacao = QMessageBox::question(this,"Confirmação!","Deseja apagar todos os dados?",QMessageBox::Yes|QMessageBox::No);

        if (confirmacao == QMessageBox::Yes)
        {
            persistenciaVendas.deleteTabela();

            persistenciaClientes.deleteTabela();

            persistenciaProdutos.deleteTabela();
